...
import static com.ceg.med.healthconnect.MainActivity.MYOAPP_LOG_TAG;
...
public class MyoGattCallback extends BluetoothGattCallback {
    ...
    public MyoGattCallback(CallbackAble<Integer> callback) {
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        ...
        Log.d(MYOAPP_LOG_TAG, "onConnectionStateChange: " + status + " -> " + newState);
        if (newState == BluetoothProfile.STATE_CONNECTED) {
            ...
            // GATT Disconnected
            Log.d(MYOAPP_LOG_TAG, "Bluetooth Disconnected");
        }
    }
